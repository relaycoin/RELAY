...
RESOURCES += src/qt/rel.qrc src/qt/rel_locale.qrc

TRANSLATIONS += src/qt/locale/rel_bg.ts \
                src/qt/locale/rel_de.ts \
                src/qt/locale/rel_en.ts \
                src/qt/locale/rel_es.ts \
                src/qt/locale/rel_fi.ts \
                src/qt/locale/rel_fr.ts \
                src/qt/locale/rel_it.ts \
                src/qt/locale/rel_ja.ts \
                src/qt/locale/rel_pl.ts \
                src/qt/locale/rel_pt.ts \
                src/qt/locale/rel_ru.ts \
                src/qt/locale/rel_sk.ts \
                src/qt/locale/rel_sv.ts \
                src/qt/locale/rel_vi.ts \
                src/qt/locale/rel_zh_CN.ts \
                src/qt/locale/rel_zh_TW.ts

...
In order to support loading of multiple wallets in rel-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rel.cpp.
...
Changes to rel.cpp
----------------------
rel.cpp is the entry point into rel-qt, and as such, will require some minor modifications to provide hooks for

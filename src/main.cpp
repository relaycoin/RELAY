...
#if defined(NDEBUG)
#error "REL cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
	...
	if(nHeight <= 1 && nHeight > 0) {
		...
		nSubsidy = 20240 * COIN;
	} else if (nHeight > 4 && nHeight <= 2592000) {
		nSubsidy = 0.5 * COIN;
	} else if (nHeight > 2592000 && nHeight <= 5184000) {
		nSubsidy = 0.6 * COIN;
	} else if (nHeight > 5184000 && nHeight <= 7776000) {
		nSubsidy = 0.7 * COIN;
	} else if (nHeight > 7776000 && nHeight <= 10368000) {
		nSubsidy = 0.8 * COIN;
	} else if (nHeight > 10368000 && nHeight <= 12960000) {
		nSubsidy = 0.9 * COIN;

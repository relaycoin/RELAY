                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("REL-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rel: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About RELAY COIN "), this);
    aboutAction->setStatusTip(tr("Show information about RELAY COIN "));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for REL"));
    ...
    openAction->setStatusTip(tr("Open a REL: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the RELAY COIN  help message to get a list with possible REL command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("RELAY COIN  client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("RELAY COIN "); // default title

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* REL features */
        {"rel", "masternode", &masternode, true, true, false},
        {"rel", "masternodelist", &masternodelist, true, true, false},
        {"rel", "mnbudget", &mnbudget, true, true, false},
        {"rel", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"rel", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rel", "mnsync", &mnsync, true, true, false},
        {"rel", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use reld, or the -server option to rel-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> rel-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:27276/\n";
}
